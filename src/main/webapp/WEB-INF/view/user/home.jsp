...
<nav class="navbar navbar-expand-lg navbar-light bg-light" style="background:pink">
  <div class="collapse navbar-collapse" id="navbarSupportedContent" style="background:pink">
    ...
    <div>
    	<ul class="nav">
    		<li class="nav-item nav-link"> <img width="35px" height="35px" src="/resource/images/v2-4ff55aaabaf7b9229750b9c3dc9da3f0_hd.jpg"> </li>
    	
    		<li class="nav-item nav-link"><a href="http://localhost:8082">点击进入主页面</a></li>
    	</ul>
    </div>
  </div>
</nav><!--  头结束 -->
...
<!-- 尾开始 -->
<nav class="nav fixed-bottom justify-content-center "  style="background:pink" height="50px"> 
	       此树是我栽  
</nav>
